...
static class LimitForceTaskHelper
{
      ...
      double mxOriginal, double myOriginal)
   {
      ...
      return new
      {
         ...
         ncrX = StrainStateJsonHelper.FiniteRounded(eta.X.Ncr, 4),
         ...
         ncrY = StrainStateJsonHelper.FiniteRounded(eta.Y.Ncr, 4),
         slenderY = eta.Y.Slender,
         stableY  = eta.Y.Stable,
         extrapolationFailedY = eta.Y.ExtrapolationFailed,
         etaHistoryY = StrainStateJsonHelper.FiniteRoundedArray(eta.Y.EtaHistory, 6),
      };
   }
