...
public class Sp63CrackWidthCheckerTests
{
    ...
    public void Check_Example47_PlateFoundation_MatchesBookWithinMethodTolerance()
    {
        ...
        // Книга: acrc = 0.155 мм. Mcrc/ψs расходятся между методиками (Wpl=1.3 vs 1.75·Wred) —
        // допуск шире, как и для Example 48 в ShellSimplSolverTests.
        Assert.InRange(detail.Applied, 0.155 * 0.7, 0.155 * 1.4);
