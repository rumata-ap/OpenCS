...
public sealed class CrackWidthSummaryVM : ViewModelBase
{
    ...
    public string PassedLongBrush { get; } = Argb.FromRgb(128, 128, 128).ToHex();
    ...
    public string PassedShortBrush { get; } = Argb.FromRgb(128, 128, 128).ToHex();
    ...
    public CrackWidthSummaryVM(CalcResult result, CrossSection? section)
    {
        ...
        PassedLongBrush = PassedLong ? Argb.FromRgb(0, 128, 0).ToHex() : Argb.FromRgb(255, 0, 0).ToHex();
        ...
        PassedShortBrush = PassedShort ? Argb.FromRgb(0, 128, 0).ToHex() : Argb.FromRgb(255, 0, 0).ToHex();
        ...
        StatusBrush = !PlaneConverged && Cracked
            ? Argb.FromRgb(255, 0, 0).ToHex()
            : (!Cracked || (PassedLong && PassedShort)) ? Argb.FromRgb(0, 128, 0).ToHex() : Argb.FromRgb(255, 69, 0).ToHex();
    }
