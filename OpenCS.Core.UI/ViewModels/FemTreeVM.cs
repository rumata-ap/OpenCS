...
public class FemSchemasGroupNode
{
...
public class FemChecksSubGroupNode
{
...
public class FemChecksRootNode
{
...
public class FemSchemaTreeVM
{
    ...
    public Task<List<FemElement>> LoadMeshBarsAsync()
    ...
    public Task<List<FemElement>> LoadMeshShellsAsync()
        => Task.Run(() => _db.GetFemMeshElements(Schema.Id)
            .Where(e => e.ElemType == "shell").ToList());
...
public class FemMeshSnapshotSubNode : FemSubNode
{
    ...
    public FemSchemaTreeVM Owner { get; }
