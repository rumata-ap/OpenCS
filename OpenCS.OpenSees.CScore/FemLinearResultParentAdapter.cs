...
public static class FemLinearResultParentAdapter
{
    ...
    public static IParentLinearResult FromLinearResult(FemLinearResult result)
    {
        ...
        foreach (var r in result.Reactions)
        ...
        foreach (var f in result.ElementForces)
        ...
        return new DictionaryParentLinearResult(isLinear: true, displacements, reactions, endForces);
    }
