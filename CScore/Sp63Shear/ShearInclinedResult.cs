...
public sealed class ShearInclinedResult
{
    ...
    /// Упрощённые условия (8.60) и (8.63′) сохранены в <see cref="Details"/>
    /// только для справочной оценки и не определяют итоговый вердикт.
    /// </summary>
    public double Utilization => UtilizationExact;

    /// <summary>
    /// Коэффициент использования только по точным проверкам (8.55), (8.56) и (8.63) —
    /// без упрощённых условий. Сохраняется отдельным полем для совместимости результатов.
    /// </summary>
