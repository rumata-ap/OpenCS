...
{
    // Границы 0,6h0…3h0 — из отсечек Qb по (8.57): Qb ≤ 2,5·Rbt·b·h0 даёт Cmin=φb2/2,5·h0=0,6h0,
    // Qb ≥ 0,5·Rbt·b·h0 даёт Cmax=φb2/0,5·h0=3,0h0 (см. спецификацию
    // docs/superpowers/specs/2026-09-09-sp63-shear-projection-ranges-design.md).
