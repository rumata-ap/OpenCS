...
public enum MomentShape
{
    ...
    AsGiven = 0,
    /// <summary>Шарнирно опёртый стержень с линейной эпюрой от концевых моментов, δ = M2/M1 (табл. Д.5).</summary>
    LinearEndMoments = 1,
}
...
public sealed record SteelDesignParams
{
    ...
    /// <summary>
    /// Отношение момента в средней трети длины к расчётному (для mx по 9.2.6: не менее 0,5);
    /// 1 — принимается расчётный момент.
    /// </summary>
