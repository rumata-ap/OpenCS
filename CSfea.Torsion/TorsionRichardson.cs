...
public sealed class TorsionAutoConvergeResult
{
    ...
    public TorsionProps ToTorsionProps()
    {
        ...
        return new TorsionProps
        {
            ...
            WarpingConstant = finest.WarpingConstant,
            ShearDeltaS = finest.ShearDeltaS,
            ShearVxUnitFieldX = finest.ShearVxUnitFieldX,
            ShearVxUnitFieldY = finest.ShearVxUnitFieldY,
