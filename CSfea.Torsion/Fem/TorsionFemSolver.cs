...
public static class TorsionFemSolver
{
        ...
        double nu = 0.2)
    {
        ...
        return new TorsionProps
        {
            ...
            ShearDeltaS = sc.DeltaS,
            ShearVxUnitFieldX = sc.ShearUnitFields.VxUnitX,
            ShearVxUnitFieldY = sc.ShearUnitFields.VxUnitY,
            ShearVyUnitFieldX = sc.ShearUnitFields.VyUnitX,
            ShearVyUnitFieldY = sc.ShearUnitFields.VyUnitY,
